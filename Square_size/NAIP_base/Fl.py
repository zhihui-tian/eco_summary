...
clf_ds = driverTiff.Create('C:/Users/zhihui.tian/Downloads/3/Classified_new_weight2.tif', naip_test_ds.RasterXSize, naip_test_ds.RasterYSize,
                          1, gdal.GDT_Float32)
...
clf_ds = driverTiff.Create('C:/Users/zhihui.tian/Downloads/4/Classified4_new_weight2.tif', naip_test_ds.RasterXSize, naip_test_ds.RasterYSize,
                          1, gdal.GDT_Float32)
clf_ds.SetGeoTransform(naip_test_ds.GetGeoTransform())
clf_ds.SetProjection(naip_test_ds.GetProjectionRef())
clf_ds.GetRasterBand(1).SetNoDataValue(-9999.0)
