...
gdf=gpd.read_file(r"C:\Users\zhihui.tian\Desktop\bigger_planet_sample_9000.shp")
gdf= gdf.loc[(gdf["SAMPLE_1"] != '`7') & (gdf["SAMPLE_1"] != "9'") & (gdf["SAMPLE_1"] != np.nan)& (gdf["SAMPLE_1"] != np.nan)& (gdf["SAMPLE_1"] !=16)]
clean_data=gdf[gdf["SAMPLE_1"].notna()]
gdf=clean_data
class_names=gdf['SAMPLE_1'].unique()
