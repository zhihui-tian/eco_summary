...
naip_fn=r"C:\Users\zhihui.tian\Desktop\planet_bigger\planet_bigger.tif"
...
segments_fn=r"C:\Users\zhihui.tian\Desktop\planet_bigger\planet_bigger_segment_9000_demo.tif"
...
classes=np.unique(ground_truth)[1:]  # ground truth is from the random sampling
...
naip_test=r"C:\Users\zhihui.tian\Downloads\image-analysis-20230131T194214Z-001\bigger_planet_suwanne\composite_before.tif"
...
# save segments to raster
segments_fn_test=r"C:\Users\zhihui.tian\Downloads\image-analysis-20230131T194214Z-001\bigger_planet_suwanne\composite_before_segmentation_demo.tif"
...
# copy of segments
clf = np.copy(segments_test).astype(np.float32)
# predict segment_id
...
clf_ds = driverTiff.Create(r"C:\Users\zhihui.tian\Downloads\image-analysis-20230131T194214Z-001\bigger_planet_suwanne\composite_before_diversity_demo.tif", naip_test_ds.RasterXSize, naip_test_ds.RasterYSize,
                          1, gdal.GDT_Float32)
